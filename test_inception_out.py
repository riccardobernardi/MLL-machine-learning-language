...
def incA1(x):
	a=(Conv2D(32,(1,1),subsample=(1,1),init='he_normal',border_mode='valid',dim_ordering='tf'))(x)
	a=(Activation('relu'))(a)
	b=(Conv2D(32,(1,1),subsample=(1,1),init='he_normal',border_mode='valid',dim_ordering='tf'))(x)
	b=(Activation('relu'))(b)
	b=(Conv2D(32,(3,3),subsample=(1,1),init='he_normal',border_mode='valid',dim_ordering='tf'))(b)
	b=(Activation('relu'))(b)
	c=(Conv2D(32,(1,1),subsample=(1,1),init='he_normal',border_mode='valid',dim_ordering='tf'))(x)
	c=(Activation('relu'))(c)
	c=(Conv2D(48,(3,3),subsample=(1,1),init='he_normal',border_mode='valid',dim_ordering='tf'))(c)
	c=(Activation('relu'))(c)
