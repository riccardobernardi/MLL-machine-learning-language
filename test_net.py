...
def stem1(x):
	a = (Conv2D(32, (3, 3), subsample=(1, 1), init='he_normal', border_mode='valid', dim_ordering='tf',
				activation='relu'))(x)
	a = (Conv2D(32, (3, 3), subsample=(1, 1), init='he_normal', border_mode='valid', dim_ordering='tf',
				activation='relu'))(a)
	a = (Conv2D(64, (3, 3), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(a)
	return a
...
def stem2(x):
	...
	b = (Conv2D(96, (3, 3), subsample=(1, 1), init='he_normal', border_mode='valid', dim_ordering='tf',
				activation='relu'))(x)
	b = merge([a, b], 'concat')
	c = (Conv2D(64, (1, 1), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(b)
	c = (Conv2D(96, (3, 3), subsample=(1, 1), init='he_normal', border_mode='valid', dim_ordering='tf',
				activation='relu'))(c)
	d = (Conv2D(64, (1, 1), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(b)
	d = (Conv2D(64, (7, 1), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(d)
	d = (Conv2D(64, (1, 7), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(d)
	d = (Conv2D(96, (3, 3), subsample=(1, 1), init='he_normal', border_mode='valid', dim_ordering='tf',
				activation='relu'))(d)
	d = merge([c, d], 'concat')
	e = (Conv2D(192, (3, 3), subsample=(1, 1), init='he_normal', border_mode='valid', dim_ordering='tf',
				activation='relu'))(d)
...
def incA(x):
	a = (Conv2D(32, (1, 1), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(x)
	b = (Conv2D(32, (1, 1), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(x)
	b = (Conv2D(32, (3, 3), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(b)
	c = (Conv2D(32, (1, 1), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(x)
	c = (Conv2D(48, (3, 3), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(c)
	c = (Conv2D(64, (3, 3), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(c)
	c = merge([a, b, c], 'concat')
	d = (Conv2D(384, (1, 1), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='linear'))(c)
...
def incA_red(x):
	...
	b = (Conv2D(384, (3, 3), subsample=(2, 2), init='he_normal', border_mode='valid', dim_ordering='tf',
				activation='relu'))(x)
	c = (Conv2D(256, (1, 1), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(x)
	c = (Conv2D(256, (3, 3), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(c)
	c = (Conv2D(384, (3, 3), subsample=(2, 2), init='he_normal', border_mode='valid', dim_ordering='tf',
				activation='relu'))(c)
	c = merge([a, b, c], 'concat')
	return c
...
def incB(x):
	a = (Conv2D(192, (1, 1), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(x)
	b = (Conv2D(128, (1, 1), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(x)
	b = (Conv2D(160, (1, 7), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(b)
	b = (Conv2D(160, (7, 1), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(b)
	b = merge([a, b], 'concat')
	c = (Conv2D(1154, (1, 1), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='linear'))(b)
...
def incB_red(x):
	a = (MaxPooling2D((3, 3), strides=(2, 2), border_mode='valid', dim_ordering='tf'))(x)
	b = (Conv2D(256, (1, 1), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(x)
	b = (Conv2D(288, (3, 3), subsample=(2, 2), init='he_normal', border_mode='valid', dim_ordering='tf',
				activation='relu'))(b)
	c = (Conv2D(256, (1, 1), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(x)
	c = (Conv2D(288, (3, 3), subsample=(2, 2), init='he_normal', border_mode='valid', dim_ordering='tf',
				activation='relu'))(c)
	d = (Conv2D(256, (1, 1), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(x)
	d = (Conv2D(288, (3, 3), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(d)
	d = (Conv2D(320, (3, 3), subsample=(2, 2), init='he_normal', border_mode='valid', dim_ordering='tf',
				activation='relu'))(d)
...
def incC(x):
	a = (Conv2D(192, (1, 1), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(x)
	b = (Conv2D(192, (1, 1), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(x)
	b = (Conv2D(224, (1, 3), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(b)
	b = (Conv2D(256, (3, 1), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='relu'))(b)
	b = merge([a, b], 'concat')
	c = (Conv2D(2048, (1, 1), subsample=(1, 1), init='he_normal', border_mode='same', dim_ordering='tf',
				activation='linear'))(b)
