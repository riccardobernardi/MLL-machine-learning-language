...
class TestMLL(TestCase):
    ...
    def entire_inception_with_function_bigger_aug_with_parmac_mini(self):
        inc = """
        conv2d := Conv2D
        seq := Sequential
        drop := Dropout
        ...
        c2d323311v := Conv2D 32 (3, 3) kkk with subsample=(1,1)
