...
class TestMLL(TestCase):
    ...
    def test_entire_inception_with_function_little(self):
        ...
        # reorder dimensions for tensorflow
        x_train = np.transpose(x_train.astype('float32') / 255., (0, 2, 1, 3))[:1000]
        x_test = np.transpose(x_test.astype('float32') / 255., (0, 2, 1, 3))[:200]
        print('x_train shape:', x_train.shape)
        print(x_train.shape[0], 'train samples')
        print(x_test.shape[0], 'test samples')
